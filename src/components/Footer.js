...
const Footer = ({handleReset}) => {
  return (
    <div className="bg-[#8e44ad] w-full flex justify-between items-center px-[73px] py-[9px] text-english-white font-aclonica h-[88px]">
      <div className="flex gap-[24px]">
        <svg
          className="cursor-pointer bg-pinkCerise rounded-full fill-lightPink hover:border-white hover:scale-110 hover:shadow-2xl hover:fill-white"
        ...
        <svg
        onClick={handleReset}
          className="cursor-pointer bg-pinkCerise border-[6px] border-lightPink rounded-full fill-lightPink hover:border-white hover:scale-110 hover:shadow-2xl hover:fill-white"
          xmlns="http://www.w3.org/2000/svg"
          width="64"
          height="64"
          viewBox="0 0 64 64"
      ...
      <div className="text-[28px] font-alfa">created by: @muslimahcoding</div>
    </div>
  );
};
