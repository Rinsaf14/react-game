  ...
  return (
    <div className="h-full relative p-[54px] font-alfa flex flex-col gap-[20px]">
      ...
      <div className="w-full flex justify-center">
        <div className="h-[161px] text-[20px] w-[500px] rounded-[20px] flex text-white p-5 bg-violet borer-solid border-4 border-white">
          {answer[index + 1]
            ? `${answer[index + 1]} . ${
      ...
      <div className="flex items-center justify-center gap-2 text-lightPink text-[64px]">
      ...
      <div className="text-center text-linkPink text-[20px]">
      ...
      <div className="absolute bottom-[10px] right-[54px] flex justify-end mx-[20px] gap-5">
        ...
        <div
          ...
          className="text-[30px] bg-pinkCerise flex items-center p-1 text-lightPink border-[6px] border-lightPink hover:scale-110 hover:text-white hover:border-white rounded-lg"
        >
          View Score
        </div>
      </div>
